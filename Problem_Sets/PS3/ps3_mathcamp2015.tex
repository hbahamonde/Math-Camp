...
\begin{enumerate}
\item Evaluate the next limits. Choose 1 of them and hand it in \LaTeX \; form.
  \begin{enumerate}
  \item $$\lim_{t\to1}\frac{t^{3}-t}{t^{2}-1}$$
  \item $$\lim_{g\to0}\frac{(g-5)^{2}-25}{g}$$
  \item $$\lim_{h\to0}\frac{\sqrt{2-h}-\sqrt{2}}{h}$$
  \item $$\lim_{i\to1}\frac{i^{2}+i-2}{i^{2}-3i+2}$$
  \item $$\lim_{j\to9}\frac{j^{2}-81}{\sqrt{j}-3}$$
  \end{enumerate}

\item Find the next derivatives. Choose 1 of them and hand it in  \LaTeX \; form.
  \begin{enumerate}
  \item 2015
  \item x
  \item $4x^{3}-3x^{2}+2x$
  \item $5h^{2}\cdot2h^{3}$
  \item $\frac{x^{2}}{3x^{2}}-\frac{3}{3x^{2}}$
  \item $\frac{6y^{2}+12y+4}{(2y-10)^{2}}$
  \end{enumerate}
